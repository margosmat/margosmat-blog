...
import { 
  ...
  SiRabbitmq, SiRedux, SiBlazor, SiGithubactions, SiOpenid
} from 'react-icons/si';
import { VscAzure } from 'react-icons/vsc';
import { TbBrandCSharp } from 'react-icons/tb';
import { FaWindows, FaDatabase, FaServer, FaCogs, FaUserShield } from 'react-icons/fa';
...
const techs = [
  ...
  { name: 'IdentityServer', icon: SiOpenid, color: '#F7931E' }, /* OpenID Connect Icon */
...
export default function TechCarousel({ title = "Technologies" }: { title?: string }) {
  return (
